<template><div><h1 id="темы" tabindex="-1"><a class="header-anchor" href="#темы"><span>Темы</span></a></h1>
<ul>
<li><RouteLink to="/go/go/pointers/">Указатели</RouteLink><br>
<RouteLink to="/reference/config.html">Config Reference</RouteLink><br>
<RouteLink to="/go/getting-started.html">Getting Started</RouteLink></li>
</ul>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code><span class="line">sdssd</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>This is a normal page, which contains VuePress basics.</p>
